...
function AppExperience() {
  ...
  return <Shell dark>
    <main className="experience-page experience-page-stories">
      <div className="experience-top stories-top"><div><p className="stories-kicker">seu espaço de conversa</p><h1>Descubra algo <em>novo.</em></h1></div><AccessPill access={activeAccess} /></div>
      <div className="experience-layout">
        ...
        <section className="question-area">
          <button className="story-peek story-peek-left" onClick={() => setQuestionIndex(i => (i - 1 + questions.length) % Math.max(questions.length, 1))} aria-label="Pergunta anterior"><span>{questionAt(-1).text}</span><Bookmark size={16} /></button>
          <button className="story-peek story-peek-right" onClick={nextQuestion} aria-label="Próxima pergunta"><span>{questionAt(1).text}</span><Bookmark size={16} /></button>
