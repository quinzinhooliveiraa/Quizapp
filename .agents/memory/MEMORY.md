...
- [Checkout price locking](checkout-price-lock.md) — once payment creation returns a price, keep that amount in session and client state until the charge is paid or expires.
