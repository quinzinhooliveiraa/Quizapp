...
**How to apply:** Whenever a landing route is added or renamed, update the route-aware splash whitelist and verify the path in both desktop and mobile previews.