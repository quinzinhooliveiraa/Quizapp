  ...
  return (
    ...
    >
      <div className="lp-container lp2-narrow">
        <p className="lp-eyebrow lp-eyebrow-center">começo leve</p>
        <h2 className="lp-h2">
          Ninguém abre o jogo <em>numa pergunta pesada.</em>
        </h2>
        <div className="lp1-mechanism-copy">
          <p className="lp2-section-lede">
            É o medo de todo mundo. É por isso que o baralho começa leve.
          </p>
          <p className="lp2-section-lede">
            Ninguém abre o jogo numa pergunta pesada. As primeiras são fáceis de
            responder até pra quem trava. A profundidade vem depois, quando os
            dois já estão dentro da conversa.
          </p>
          <p className="lp2-section-lede">
            E ninguém vai achar que você virou filósofo: quem faz a pergunta é a
            carta, não você. Vale pros dois, aliás. Você também não precisa
